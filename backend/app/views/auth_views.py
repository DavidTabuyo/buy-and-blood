...
# Obtén el modelo de usuario personalizado definido en AUTH_USER_MODEL
...
def google_callback(request):
    ...
    # 4. Verificar el ID Token con la librería oficial
    ...
    # 6. Iniciar sesión y crear la cookie de sesión
    login(request, user)

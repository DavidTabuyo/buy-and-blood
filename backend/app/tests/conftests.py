...
# Forzamos a utilizar la url del .env
...
#APIClient para peticiones REST
@pytest.fixture
def api_client():
    return APIClient()

# Base de datos limpia: apply migrations o crear tablas
...
# Ejemplo de factory con factory_boy
